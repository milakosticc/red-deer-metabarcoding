...
input_dir <- "working/Plants_trnLc-trnLh/primersCut_out"
output_dir <- "working/Plants_trnLc-trnLh/qualFiltered_out"
...
write.csv(
  summary,
  "working/Plants_trnLc-trnLh/seq_count_summary.csv",
  row.names = FALSE
)
