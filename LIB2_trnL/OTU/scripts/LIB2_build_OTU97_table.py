...
uc_file = "taxonomy/otu_97/LIB2_OTU97_clusters.uc"
asv_table = "taxonomy/input/LIB2_final_ASV_table.csv"
centroids_in = "taxonomy/otu_97/LIB2_OTU97_centroids_raw.fasta"

mapping_out = "taxonomy/otu_97/LIB2_ASV_to_OTU97.tsv"
table_out = "taxonomy/otu_97/LIB2_OTU97_abundance_counts.tsv"
centroids_out = "taxonomy/otu_97/LIB2_OTU97_centroids.fasta"
...
# Rename centroid sequences with OTU IDs
written = 0
...
print("=== LIB2 OTU97 TABLE VALIDATION ===")
...
print("All ASVs mapped:", len(asv_to_otu) == 341)
