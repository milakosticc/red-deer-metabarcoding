...
counts_in = "taxonomy/otu_97/LIB2_OTU97_abundance_counts.tsv"
taxonomy_in = "taxonomy/otu_97/LIB2_OTU97_taxonomy.tsv"
metadata_in = "taxonomy/ecology_input/LIB2_metadata_template.tsv"

outdir = "taxonomy/ecology_input/OTU97"
os.makedirs(outdir, exist_ok=True)

counts_out = f"{outdir}/LIB2_OTU97_feature_abundance_counts.tsv"
taxonomy_out = f"{outdir}/LIB2_OTU97_taxonomy.tsv"
metadata_out = f"{outdir}/LIB2_OTU97_metadata_template.tsv"
...
print("=== LIB2 OTU97 ECOLOGY INPUT ===")
