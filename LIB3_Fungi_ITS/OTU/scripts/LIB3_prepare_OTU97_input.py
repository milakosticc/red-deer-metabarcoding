...
fasta_file = "taxonomy/final/LIB3_target_fungi_ASVs.fasta"
out_fasta = "taxonomy/otu_97/LIB3_ASVs_with_size.fasta"
...
print("ASV count match:", len(asv_cols) == 211)
